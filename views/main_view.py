...
class MainView:
    ...
    def create_widgets(self):
        ...
        tk.Button(self.root, text="Generar CH", command=self.generar_ch).grid(row=2, column=0, padx=10, pady=20)
        tk.Button(self.root, text="Generar DH", command=self.generar_dh).grid(row=2, column=2, padx=10, pady=20)
        ...
        self.developer_label.grid(row=2, column=0, columnspan=3, pady=5)
    ...
    def generar_ch(self):
        ...
        try:
            ...
            ch_controller.generar_ch(input_dir, output_dir)
            messagebox.showinfo("Éxito", "Archivos CH generados correctamente.")
    ...
    def generar_dh(self):
        ...
        try:
            ...
            dh_controller.generar_dh(input_dir, output_dir)
            messagebox.showinfo("Éxito", "Archivos DH generados correctamente.")
        except Exception as e:
